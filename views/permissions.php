...
<div class="tabcontent">
    <div class="tabbody" style="display:block">
        <div class="button"><a href="<?php echo BASE_URL; ?>/permissions/add_group" class="button">Adicionar Grupo de Permissões</a></div>
    ...
    <div class="tabbody">
        <div class="button"><a href="<?php echo BASE_URL; ?>/permissions/add" class="button">Adicionar Permissão</a></div>
        <table border="0" width="100%">
            <tr>
